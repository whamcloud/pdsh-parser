...
describe("pdsh parser", function() {
  ...
  const tests = [
    ...
    // single item in reverse order
    {
      expression: "hostname[7-5]",
      expanded: {
        expansion: ["hostname5", "hostname6", "hostname7"],
        sections: ["hostname5..7"],
        expansionHash: {
          hostname5: 1,
          hostname6: 1,
          hostname7: 1
    ...
    // combined.
    {
      ...
      expanded: {
        ...
        sections: ["hostname2..3.iml.com", "hostname5..7.iml.com", "hostname10..12.iml.com", "hostname15..17.iml.com"],
        expansionHash: {
          "hostname2.iml.com": 1,
          "hostname3.iml.com": 1,
          "hostname5.iml.com": 1,
